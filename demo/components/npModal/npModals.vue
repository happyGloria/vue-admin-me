<template>
<div class="np-modals" v-show='modals.length'>
...
<script>
const ZIndexBase = 10001;
const DeltaZIndex = 100;
...
export default {
	...
	methods: {
		...
		create: function (modal) {
			...
			m.ifMask = $XP(options, 'mask', false);
			...
			this.modals.push(m);
			return {
				show: function () { m.visible = true; self._refresh(); },
				hide: function () { m.visible = false; self._refresh(); },
				animateDestory: function (ms) {
					m.visible = false;
					self._refresh();
